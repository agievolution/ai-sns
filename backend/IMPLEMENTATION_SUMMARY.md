...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/config/settings.py` (259 lines)
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/config/database.py` (86 lines)
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/core/dependencies.py` (167 lines)
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/shared/websocket_manager.py` (210 lines)
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/shared/ai_client.py` (293 lines)
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/shared/utils.py` (386 lines)
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/README.md`
...
#### `/mnt/c/dev/agi-ev/ai-sns-el/backend/test_backend.py`
...
|-------------------------------|--------------|
| `get_ai_config()` (lines 103-172) | `backend.config.settings.Settings._load_ai_config()` |
| `ConnectionManager` (lines 76-97) | `backend.shared.websocket_manager.ConnectionManager` |
| Streaming chat logic (lines 638-756) | `backend.shared.ai_client.AIClient.chat_completion_stream()` |
| Database imports (lines 32-44) | `backend.config.database` |
| Various utility functions | `backend.shared.utils` |

### Next Steps for Integration

1. Update `api_server.py` to import from `backend.*` modules
...
from backend.core.dependencies import get_db_session, verify_api_key
...
```python
from backend.shared.websocket_manager import manager
...
### 4. AI Client Usage
```python
from backend.shared.ai_client import get_ai_client
