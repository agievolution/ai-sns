...
# WebSocket
from backend.shared.websocket_manager import ConnectionManager, manager

# AI Client
from backend.shared.ai_client import AIClient, get_ai_client, get_default_client
...
```python
from backend.core.dependencies import RateLimiter
...
```python
from backend.core.dependencies import pagination_params
...
```
/mnt/c/dev/agi-ev/ai-sns-el/backend/
├── config/
...
### Issue: "Import error"
**Solution**: Make sure you're importing from backend.* modules
