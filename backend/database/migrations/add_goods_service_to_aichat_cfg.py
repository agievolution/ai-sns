"""
Migration: Add goods/service description and price columns to aichat_cfg table
"""
...
def migrate() -> bool:
    ...
    try:
        ...
        if "goods_or_service_description" not in columns:
            print("Adding goods_or_service_description column to aichat_cfg table...")
        ...
        if "goods_or_service_price" not in columns:
            print("Adding goods_or_service_price column to aichat_cfg table...")
